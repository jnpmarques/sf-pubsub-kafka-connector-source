package eu.jnpmarques.genericpubsub;
...
public class Subscribe extends CommonContext {
    ...
    public static Configuration exampleConfigurations;
    ...
    public Subscribe(Configuration exampleConfigurations) {
    ...
    public Subscribe(Configuration exampleConfigurations, StreamObserver<FetchResponse> responseStreamObserver) {
        super(exampleConfigurations);
        isActive.set(true);
        this.exampleConfigurations = exampleConfigurations;
        this.BATCH_SIZE = exampleConfigurations.getNumberOfEventsToSubscribeInEachFetchRequest();
